...
def parse_args(arg_list: None | List[str] = None) -> Config:
    ...
    parser.add_argument("--radius_range", type=float, nargs=2, default=[1, 1.5])
    parser.add_argument("--sample_range", type=float, nargs=2, default=[0.25, 3])
    ...
    parser.add_argument("--check_render_samples", type=int, default=64)
